...
<section class="mt-12">
  ...
  <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
    ...
    <div class="p-5 rounded-xl border bg-green-50 dark:bg-green-900/10 border-green-200 dark:border-green-800 flex gap-3 items-start">
      <span class="text-2xl shrink-0">⚡</span>
      <div><h4 class="font-semibold text-sm">Energy Monitoring</h4><p class="text-xs text-muted mt-1">Real-time power consumption tracking for commercial & industrial setups.</p></div>
    </div>
